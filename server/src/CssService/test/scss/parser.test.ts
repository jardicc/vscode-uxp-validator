...
import { ParseError } from "../../../CssServiceOriginal/parser/cssErrors";
import { SCSSParseError } from "../../../CssServiceOriginal/parser/scssErrors";
...
suite("SCSS - Parser", () => {
	...
	test("@forward", function () {
		...
		assertNode("@forward \"../forms.scss\" as components-* with ( $field-border: false )", parser, parser._parseForward.bind(parser)); // #145108
