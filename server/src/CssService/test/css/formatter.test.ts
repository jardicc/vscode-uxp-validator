 ...
 *--------------------------------------------------------------------------------------------*/
import { getCSSLanguageService, TextDocument, Range, getLESSLanguageService, LanguageService } from "../../../CssServiceOriginal/cssLanguageService";
import * as assert from "assert";
import { CSSFormatConfiguration } from "../../../CssServiceOriginal/cssLanguageTypes";
