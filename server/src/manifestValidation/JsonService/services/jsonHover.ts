...
import { TextDocument, PromiseConstructor, Thenable, Position, Range, Hover, MarkedString, JSONSchema } from '../jsonLanguageTypes';
...
export class JSONHover {
	...
	public doHover(document: TextDocument, position: Position, doc: Parser.JSONDocument, customSchema?:JSONSchema): Thenable<Hover | null> {
		...
		return this.schemaService.getSchemaForResource(document.uri, doc).then((schema) => {
			if (customSchema) {
				schema = new SchemaService.ResolvedSchema(customSchema, [], [], undefined);
			}
			if (schema && node) {
