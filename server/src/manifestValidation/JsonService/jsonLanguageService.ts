...
import { ISchemaContributions, JSONSchemaService, ResolvedSchema } from "./services/jsonSchemaService";
...
export interface LanguageService {
	...
	doComplete(document: TextDocument, position: Position, doc: JSONDocument, customSchema?: ResolvedSchema): Thenable<CompletionList | null>;
	...
	doHover(document: TextDocument, position: Position, doc: JSONDocument, schema?:JSONSchema): Thenable<Hover | null>;
...
export function getLanguageService(params: LanguageServiceParams, customSchemaConfiguration?:ISchemaContributions): LanguageService {
	const promise = params.promiseConstructor || Promise;

	const jsonSchemaService = new JSONSchemaService(params.schemaRequestService, params.workspaceContext, promise);
	// Possibility to add custom schema
	jsonSchemaService.setSchemaContributions({
		schemaAssociations: [
			...schemaContributions.schemaAssociations ?? [],
			...customSchemaConfiguration?.schemaAssociations ?? [],
		],
		schemas: {
			...schemaContributions.schemas ?? {},
			...customSchemaConfiguration?.schemas ?? {},
		},
	});
